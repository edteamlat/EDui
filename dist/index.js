...
var EDgrid = React.forwardRef(function (props, ref) {
  ...
  return React.createElement(Component, _extends({
    ref: ref,
    className: classnames("ed-grid", className, "s-grid-".concat(small), "m-grid-".concat(medium), "lg-grid-".concat(large), rowsGap && "rows-gap", typeof gap === "number" && "gap-".concat(gap))
  }, restProps), children);
});
EDgrid.propTypes = {
  as: PropTypes.elementType,
...
var CardHeader = React.forwardRef(function (props, ref) {
  var image = props.image,
      ...
      children = props.children,
      alt = props.alt,
      restProps = _objectWithoutProperties(props, ["image", "className", "imageClasses", "children", "alt"]);

  return React.createElement(CardContext.Consumer, null, function (_ref) {
    var horizontal = _ref.horizontal;
    return image ? React.createElement("div", _extends({
