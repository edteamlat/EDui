...
function (_Component) {
  ...
  function TabsWrapper() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TabsWrapper)).call.apply(_getPrototypeOf2, [this].concat(props)));
    _this.state = {
      active: 0
    };
    _this.toggleActiveTab = _this.toggleActiveTab.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(TabsWrapper, [{
    key: "toggleActiveTab",
    value: function toggleActiveTab(newActiveTab) {
      this.setState({
        active: newActiveTab
      });
    }
  ...
  return TabsWrapper;
}(React.Component); // TabsWrapper.propTypes = {
// 	children: PropTypes.node
// };

_defineProperty(TabsWrapper, "Tabs", function (props) {
  return React__default.createElement(Tabs, props, props.children);
});

_defineProperty(TabsWrapper, "Tab", function (props) {
  return React__default.createElement(TabsContext.Consumer, null, function (value) {
    return React__default.createElement(Tab, _extends({}, props, {
      active: value.active,
      reference: props.reference,
      onClick: function onClick() {
        return value.toggleActiveTab(props.reference);
      }
    }), props.children);
  });
});

_defineProperty(TabsWrapper, "Panels", function (props) {
  return React__default.createElement("div", props, props.children);
});

_defineProperty(TabsWrapper, "Panel", function (props) {
  return React__default.createElement(TabsContext.Consumer, null, function (value) {
    return React__default.createElement("div", _extends({}, props, {
      style: {
        display: props.reference === value.active ? 'block' : 'none'
      }
    }), props.children);
  });
});
...
var EDitem = styled__default.div(_templateObject$s(), function (_ref) {
  var s = _ref.s,
      ...
      _ref$lg = _ref.lg,
      lg = _ref$lg === void 0 ? l : _ref$lg;
  return styled.css(_templateObject2$5(), SMALL_BREAKPOINT, s, MEDIUM_BREAKPOINT, m, LARGE_BREAKPOINT, l, EXTRA_LARGE_BREAKPOINT, lg);
}, function (props) {
